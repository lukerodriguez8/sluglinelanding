...
<head>
  ...
  <style>
    ...
    @media screen and (max-width: 600px) {
      /* Reverts to tighter padding on mobile so it doesn't push content below the fold */
...
<body style="margin: 0; padding: 0; background-color: #000000;">
  ...
  <div style="display: none; font-size: 1px; color: #000000; line-height: 1px; max-height: 0px; max-width: 0px; opacity: 0; overflow: hidden;">
    Thank you for your interest in Slugline Studio. You're a little early.
  ...
  <table role="presentation" width="100%" cellspacing="0" cellpadding="0" border="0" bgcolor="#000000" style="background-color: #000000;">
    <tr>
      <td class="outer-pad" align="center" style="background-color: #000000; padding: 120px 20px;">
        <table class="container" role="presentation" width="600" cellspacing="0" cellpadding="0" border="0" bgcolor="#000000" style="width: 100%; max-width: 600px; margin: 0 auto; background-color: #000000; border: 1px solid #ffffff; border-radius: 12px; overflow: hidden;">
          <tr>
            <td class="content" align="center" style="padding: 80px 40px; text-align: center;">
              ...
              <div class="masthead-wrapper" style="margin-bottom: 48px;">
              ...
              <div class="text-container" style="max-width: 480px; margin: 0 auto; text-align: center;">
                ...
                <p style="margin: 0 0 24px 0; color: #ffffff; font-size: 16px; line-height: 1.5; font-weight: 400; letter-spacing: -0.01em; font-family: 'Neue Haas Grotesk Text', 'Inter', ui-sans-serif, system-ui, -apple-system, sans-serif;">
                  Thank you for your interest in Slugline Studio.
                </p>
                ...
                <p style="margin: 0 0 24px 0; color: #ffffff; font-size: 16px; line-height: 1.5; font-weight: 400; letter-spacing: -0.01em; font-family: 'Neue Haas Grotesk Text', 'Inter', ui-sans-serif, system-ui, -apple-system, sans-serif;">
                  Built to drive conversion across every marketing surface.<br>
                  AI to find the signal, and journalistic instinct to shape it.<br>
                  A system that learns and shifts autonomously.
                </p>
                
                <p style="margin: 48px 0 0 0; color: #ffffff; font-size: 16px; line-height: 1.5; font-weight: 400; letter-spacing: -0.01em; font-family: 'Neue Haas Grotesk Text', 'Inter', ui-sans-serif, system-ui, -apple-system, sans-serif;">
